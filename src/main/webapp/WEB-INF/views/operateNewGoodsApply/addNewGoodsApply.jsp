...
<script  src="${ctx}/static/js/views/operateNewGoodsApply/addNewGoodsApply.js?V=${versionNo}"></script>
        ...
        <div class="ub ub-ver ub-ac upad-4">
            <div class="ub upad-4">
                ...
                <div class="ub ub-ac uw-300">
                  ...
                  <input id="barCode" name="barCode"  class="uinp  easyui-validatebox uw-200 " maxlength="25">
                   <!--  <i class="ub uc-red">*</i> -->
                </div>
            </div>
            <div class="ub upad-4">
