...
<title>门店财务费用-新增</title>

<%@ include file="/WEB-INF/views/include/header.jsp"%>
<c:set var="ctx" value="${pageContext.request.contextPath}" />
<script
	src="${ctx}/static/js/views/finance/financeCharge/financeChargeMain.js?V=${versionNo}"></script>
<style>
	...
	<div class="ub ub-ver ub-f1 umar-4  ubor">
		<div class="ub ub-ac upad-4">
			<div class="ubtns">
				...
				<shiro:hasPermission name="JxcFinanceCharge:delete">
			...
			<div class="ub ub-ver upad-8">
				<div class="ub umar-t8">
					...
					<div class="ub ub-ac umar-r80">
						...
						<input class="Wdate uw-300 uinp-no-more" name="chargeMonth" id="chargeMonth" onclick="WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-%M'})" />
					</div>
					<div class="ub ub-ac umar-r80">
