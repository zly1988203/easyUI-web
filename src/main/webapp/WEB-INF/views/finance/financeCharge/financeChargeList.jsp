...
<title>门店财务费用登记</title>

<%@ include file="/WEB-INF/views/include/header.jsp"%>
<c:set var="ctx" value="${pageContext.request.contextPath}" />
<script
	src="${ctx}/static/js/views/finance/financeCharge/financeChargeList.js?V=${versionNo}"></script>
<style>
			...
			<div class="ub ub-ac">
				<div class="ubtns">
					...
					<div id="updatePermission" class="none">
						<shiro:hasPermission name="JxcFinanceCharge:update">修改</shiro:hasPermission>
					</div>
				</div>
