	...
	<div class="ub ub-ver ub-f1 umar-4 upad-4">
		<form id="queryForm">
			...
			<div class="ub umar-t8"><div class="ub ub-ac umar-r40">
				<div class="umar-r10 uw-60 ut-r">费用名称:</div>
	                 <select class='uinp easyui-combobox uinp-no-more' id="costTypeId" name="costTypeId" style="width:204px;"
	                 data-options="valueField:'id',textField:'label',url:'${ctx}/archive/financeCode/getDictListByTypeCode?dictTypeCode=101005'">
	                 </select>
	            </div>
                <div class="ub ub-ac umar-r40">
