...
<title>营业外支出-编辑查看</title>

<%@ include file="/WEB-INF/views/include/header.jsp"%>
<c:set var="ctx" value="${pageContext.request.contextPath}" />
<script
	src="${ctx}/static/js/views/finance/nonExpend/expendMain.js?V=${versionNo}"></script>
<style>
...
<body class="ub ub-ver uw uh ufs-14 uc-black">
	...
	<div class="ub ub-ver ub-f1 umar-4 ubor">
		<div class="ub ub-ac upad-4">
			<div class="ubtns">
				<shiro:hasPermission name="JxcNonExpend:add">
				...
				<c:if test="${ 'edit' eq chargeStatus }">
					...
					<shiro:hasPermission name="JxcNonExpend:audit">
					...
					<shiro:hasPermission name="JxcNonExpend:delete">
				...
				<c:if test="${ 'check' eq chargeStatus }">
					...
					<div class="ubtns-item-disabled" >支出选择</div>
					<div class="ubtns-item-disabled" >支出导入</div>
					<shiro:hasPermission name="JxcNonExpend:delete">
