...
<title>营业外支出-查询</title>

<%@ include file="/WEB-INF/views/include/header.jsp"%>
<c:set var="ctx" value="${pageContext.request.contextPath}" />
<script
	src="${ctx}/static/js/views/finance/nonExpend/expendSearch.js?V=${versionNo}"></script>
<style>
...
<body class="ub uw uh ufs-14 uc-black">
	<div class="ub ub-ver ub-f1 umar-4 upad-4">
		<form id="queryForm">
			<div class="ub ub-ac">
				<div class="ubtns">
					...
					<shiro:hasPermission name="JxcNonExpendSearch:export">
			...
			<div class="ub umar-t8">
				<div class="ub ub-ac umar-r40">
					 <div class="umar-r10 uw-60 ut-r">支出名称:</div>
	                 <select class='uinp easyui-combobox uinp-no-more' id="costTypeId" name="costTypeId" style="width:204px;"
	                 data-options="valueField:'id',textField:'label',url:'${ctx}/archive/financeCode/getDictListByTypeCode?dictTypeCode=101008'">
	                 </select>
	            </div>
                <div class="ub ub-ac umar-r40">
				...
				<div class="ub ub-ac umar-r40">
					...
					<div class="ub ub-ac umar-r10">
						<input class="radioItem" type="radio" name="queryType" id="status0"
							value="total" checked="checked" /><label for="status0">支出汇总 </label>
					</div>
					<div class="ub ub-ac umar-r10">
						<input class="radioItem" type="radio" name="queryType" id="status1"
							value="detail" /><label for="status1">支出明细 </label>
					</div>
				</div>
			</div>
		...
		<div class="ub uw umar-t8 ub-f1">
			<table id="gridNonExpendSearch"></table>
		</div>
