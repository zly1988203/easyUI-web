...
<title>营业外收入-列表</title>

<%@ include file="/WEB-INF/views/include/header.jsp"%>
<c:set var="ctx" value="${pageContext.request.contextPath}" />
<script
	src="${ctx}/static/js/views/finance/nonIncome/incomeList.js?V=${versionNo}"></script>
<style>
...
<body class="ub uw uh ufs-14 uc-black">
	<div class="ub ub-ver ub-f1 umar-4 upad-4">
			...
			<div class="ub ub-ac">
				<div class="ubtns">
					...
					<div id="updatePermission" class="none">
						<shiro:hasPermission name="JxcNonIncome:update">修改</shiro:hasPermission>
					</div>
				</div>
		...
		<div class="ub uw umar-t8 ub-f1">
			<table id="gridNonIncomeList"></table>
		</div>
