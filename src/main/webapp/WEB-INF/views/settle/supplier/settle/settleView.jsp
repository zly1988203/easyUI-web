...
<head>
    ...
    <script  src="${ctx}/static/js/views/settle/supplier/settle/settleView.js?V=2.6.0"></script>
    <style>
        ...
        <div class="ub umar-t8">
         ...
         <div class="ub umar-t8">
             ...
             <div class="ub ub-ac umar-l50">
                 ...
                 <div class="utxt"><fmt:formatDate value="${settleVo.auditTime}" pattern="yyyy-MM-dd HH:mm"/></div>
             </div>
         </div>
         <div class="ub umar-t8">
             <div class="ub ub-ac uw-280 umar-l20">
...
<!--                  </select> -->
                 <select class='uinp easyui-combobox' style="width:204px;" id="payType" name="payType" data-options="valueField:'id',disabled:true,value:'${settleVo.payType}', textField:'label',url:'${ctx}/archive/financeCode/getDictListByTypeCode?dictTypeCode=101003',editable:false" >
                 </select>
             </div>
         ...
         <div class="ub umar-t8">
             ...
             <div class="ub ub-ac uw-300 umar-l24">
                 ...
                 <input class="uinp "  value="${settleVo.actualAmount}" readonly="readonly" type="text" id="actualAmount"  name="actualAmount">
             </div>
         </div>
         ...
         <div class="ub umar-t8">
             <div class="ub ub-ac umar-l20 uw-600 " style="width:908px;" >
                 ...
                 <input class="uinp ub ub-f1" type="text" id="remark" readonly='readonly' maxlength="20" value="${settleVo.remark}" name="remark">
             </div>               
         </div>
         </form>
           <%--datagrid-edit--%>
           <div class="ub ub-f1 datagrid-edit umar-t8">
            <table id="supplierChkAccountView" ></table>
        </div>
    </div>
