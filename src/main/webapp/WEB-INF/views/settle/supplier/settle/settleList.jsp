...
<head>
    ...
    <script  src="${ctx}/static/js/views/settle/supplier/settle/settleList.js?V=2.6.0"></script>
     <style>
...
<body class="ub uw uh ufs-14 uc-black">
    <div class="ub ub-ver ub-f1 umar-4 upad-4">
		<form id="queryForm" action="" method="post">
			<!-- serviceType 是否开启结算  -->
			<input type="hidden" id="serviceType" name="serviceType" value="no">
			<div class="ub ub-ac">
	            <div class="ubtns">
					<div class="ubtns-item" onclick="queryForm()">查询</div>
					<shiro:hasPermission name="JxcSupplierSettle:add">
					<div class="ubtns-item" onclick="addSupAcoSetForm()">新增</div>
					</shiro:hasPermission>
					<shiro:hasPermission name="JxcSupplierSettle:delete">
					<div class="ubtns-item" onclick="delSupAcoSetForm()">删除</div>
					</shiro:hasPermission>
