...
<head>
    ...
    <script  src="${ctx}/static/js/views/settle/supplier/check/checkView.js?V=2.6.0"></script>
    <style>
    ...
    <div class="ub ub-ver ub-f1 umar-4  ubor">
        <div class="ub ub-ac upad-4">
            <div class="ubtns">
                ...
                <shiro:hasPermission name="JxcSupplierCheck:exportDetail">
        ...
        <div class="ub umar-t8">
         ...
         <div class="ub umar-t8">
             ...
             <div class="ub ub-ac umar-l40">
                 ...
                 <div class="utxt">${checkVo.auditUserName}</div>
             </div>
             <div class="ub ub-ac umar-l50">
                 <div class="umar-r10 uw-60 ut-r">审核时间:</div>
                 <div class="utxt"><fmt:formatDate value="${checkVo.auditTime}" pattern="yyyy-MM-dd HH:mm"/></div>
             </div>
         </div>
         <div class="ub umar-t8">
	         <div class="ub ub-ac uw-290 umar-l10">
	         ...
	         <div class="ub ub-ac uw-290 umar-l24">
				 ...
				 <select class='uinp easyui-combobox' style="width:212px;" id="payType" name="payType" data-options="valueField:'id',textField:'label',disabled:true,value:'${checkVo.payType}',url:'${ctx}/archive/financeCode/getDictListByTypeCode?dictTypeCode=101003',editable:false" >
                 </select>
             </div>
         </div>
         <div class="ub umar-t8">
             <div class="ub ub-ac umar-l10 uw-600 " style="width:606px;" >
                 ...
                 <input class="uinp ub ub-f1" type="text" id="remark" readonly='readonly' maxlength="20"  name="remark" value="${checkVo.remark}" >
             </div>               
         </div>
         </form>
