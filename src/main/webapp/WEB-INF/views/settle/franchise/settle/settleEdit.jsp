...
<head>
    ...
    <script  src="${ctx}/static/js/views/settle/franchise/settle/settle.js?V=${versionNo}"></script>
    <style>
        ...
        <div class="ub ub-ac upad-4">
            <div class="ubtns">
				...
				<shiro:hasPermission name="JxcFranchiseSettle:audit">
                	<div class="ubtns-item" onclick ="auditFranchiseSet()">审核</div>
                </shiro:hasPermission>
				<shiro:hasPermission name="JxcFranchiseSettle:delete">
                	<div class="ubtns-item" onclick="delFrachiseForm()" >删除</div>
                </shiro:hasPermission>
        ...
        <div class="ub umar-t8">
         ...
         <div class="ub umar-t8">
             ...
             <div class="ub ub-ac uw-300 umar-l8">
             	 ...
             	 <input class="uinp easyui-numberbox" data-options="precision:2,onChange:changeActMountFrom" type="text" id="actualAmount" 
         ...
         <div class="ub umar-t8">
             <div class="ub ub-ac umar-l20 uw-600 " style="width:593px;" >
                 ...
                 <input class="uinp ub ub-f1" type="text" id="remark" maxlength="20" value="${settle.remark}" name="remark">
             </div>               
         </div>
           <%--datagrid-edit--%>
