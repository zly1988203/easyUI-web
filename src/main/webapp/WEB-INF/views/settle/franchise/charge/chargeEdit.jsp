...
<head>
    ...
    <script  src="${ctx}/static/js/views/settle/franchise/charge/charge.js?V=${versionNo}"></script>
    <style>
...
<body class="ub uw uh ufs-14 uc-black">
    ...
    <div class="ub ub-ver ub-f1 umar-4  ubor">
        <div class="ub ub-ac upad-4">
            <div class="ubtns">
				<shiro:hasPermission name="JxcFranchiseCharge:add">
                	<div class="ubtns-item" onclick="addFraChargeForm()">新增</div>
                </shiro:hasPermission>
				<shiro:hasPermission name="JxcFranchiseCharge:add">
                	<div class="ubtns-item" onclick="saveFraChargeOrder()">保存</div>
                </shiro:hasPermission>
				<shiro:hasPermission name="JxcFranchiseCharge:audit">
                	<div class="ubtns-item" onclick ="auditFraChargeForm()">审核</div>
                </shiro:hasPermission>
				...
				<shiro:hasPermission name="JxcFranchiseCharge:export">
                	<div class="ubtns-item" onclick="exportOrder()">导出明细</div>
                </shiro:hasPermission>
				<shiro:hasPermission name="JxcFranchiseCharge:print">
        ...
        <div class="ub umar-t8">
           ...
           <div class="ub ub-f1 datagrid-edit umar-t8">
            <table id="franchiseChargeListAdd" ></table>
        </div>
    </div>
