        ...
        <div class="ub umar-t8">
         ...
         <div class="ub umar-t8">
            ...
            <div class="ub ub-ac uw-300 umar-l28">
	             ...
	             <input class="uinp ub ub-f1 uinp-no-more" value="<fmt:formatNumber value="${settleVo.profitAmount}" pattern="0.00"/>" id="profit" readonly='readonly'  name="profitAmount">
             </div>
             <div class="ub ub-ac umar-l40">
         ...
         <div class="ub umar-t8">
             ...
             <div class="ub ub-ac uw-320 umar-l8">
	             ...
	             <input class="uinp ub ub-f1 uinp-no-more" value="<fmt:formatNumber value="${settleVo.franchiseProfitAmount}" pattern="0.00"/>" type="text"  id="profitSupper" readonly='readonly'  name="franchiseProfitAmount">
             </div>
