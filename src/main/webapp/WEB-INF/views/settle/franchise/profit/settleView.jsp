        ...
        <div class="ub umar-t8">
         ...
         <div class="ub umar-t8">
             <div class="ub ub-ac uw-310 umar-l6">
	             ...
	             <input class="easyui-numberbox uw-204 editInput" data-options="precision:2" data-value="${settleVo.targetProfitAmount}" id="profitOfCompany" readonly='readonly'  name="targetProfitAmount">
             </div>
             <div class="ub ub-ac uw-320 umar-l8">
             	 <div class="umar-r10 uw-110 ut-r">加盟店应得毛利:</div>
	             <input class="easyui-numberbox uw-200 editInput" data-options="precision:2" data-value="${settleVo.franchiseProfitAmount}" id="profitSupper" readonly='readonly'  name="franchiseProfitAmount">
             </div>
             <div class="ub ub-ac uw-304 umar-l20">
                 <div class="umar-r10 uw-90 ut-r">本次收款金额:</div>
             	 <input class="easyui-numberbox uw-200 editInput" data-options="precision:2" data-value="${settleVo.totalAmount}" id="amount" readonly='readonly'  name="totalAmount">
             </div>
             <div class="ub ub-ac uw-300 umar-l16">
             	 <div class="umar-r10 uw-90 ut-r">其他收款金额:</div>
             	 <input class="uinp easyui-numberbox editInput" data-options="precision:2" data-value="${settleVo.otherAmount}" type="text"  id="otherAmount" readonly='readonly' name="otherAmount">
             </div>
         </div>
         <div class="ub umar-t8">
