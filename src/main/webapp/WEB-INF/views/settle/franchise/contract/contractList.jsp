		...
		<form id="queryForm" action="" method="post">
			<div class="ub ub-ac">
				<div class="ubtns">
					...
					<shiro:hasPermission name="JxcFranchiseContract:terminate">
						<div class="ubtns-item" onclick="endContact()">终止</div>
					</shiro:hasPermission>
					<shiro:hasPermission name="JxcFranchiseContract:delete">
			...
			<div class="ub umar-t8">
				...
				<div class="ub ub-ac umar-l40">
					...
					<input class="uinp ub ub-f1" id="contractNo" name="formNo" type="text" maxlength="50">
				</div>
			</div>
			<div class="ub umar-t8">
				<div class="ub ub-ac umar-r40">
					<div class="umar-r10 uw-70 ut-r">经办人:</div>
					<input class="uinp" type="text" id="operateUserName" name="franchiseAgentName">
				</div>
				<div class="ub ub-ac umar-r40">
					<div class="umar-r10 uw-70 ut-r">合同名称:</div>
					<input class="uinp" type="text" id="contractName" name="formName">
				</div>
