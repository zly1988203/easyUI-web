				        ...
				        <form id="contractForm">
				        	...
				        	<div class="ub ub-ac umar-t12">
				        		<div class="ub ub-ac uw-300">
					        		...
					        		<input class="Wdate" style="width: 175px;" readonly="readonly" value="<fmt:formatDate value="${contractVo.validityTimeStart}" pattern="yyyy-MM-dd "/>" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd ',maxDate:'#F{$dp.$D(\'endTime\');}'})" type="text" id="startTime" name="validityTimeStart" >
					        		<i class="ub ub-ac uc-red">*</i>
				        		</div>
				        		<div class="ub ub-ac uw-250  umar-l8">
					        		<label class="ub ub-pe umar-r8">有效期止:</label>
					        		<input class="Wdate" style="width: 175px;" readonly="readonly" value="<fmt:formatDate value="${contractVo.validityTimeEnd}" pattern="yyyy-MM-dd "/>" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd ',minDate:'#F{$dp.$D(\'startTime\');}'})" type="text" id="endTime" name="validityTimeEnd" >
					        		<i class="ub ub-ac uc-red">*</i>
				        		</div>
				        	</div>
				        	...
				        	<div class="ub ub-ac umar-t12">
				        		...
				        		<div class="ub ub-ac uw-250  umar-l8">
					        		...
					        		<input class="uinp ub ub-f1 uinp-no-more" type="text"  id="targetAgentPhone"  name="targetAgentPhone"  value="${contractVo.targetAgentPhone}" maxlength="15" placeholder="18809098888/0755-88880000">
				        		</div>
				        	</div>
				        	...
				        	<div class="ub ub-ac umar-t12">
				        		...
				        		<div class="ub ub-ac uw-250  umar-l8">
					        		<label class="ub ub-pe umar-r8">联系电话:</label>
					        		<input class="uinp ub ub-f1 uinp-no-more"  type="text"   id="franchiseAgentPhone" name="franchiseAgentPhone" value="${contractVo.franchiseAgentPhone}" maxlength="15" placeholder="18809098888/0755-88880000">
				        		</div>
				        	</div>
