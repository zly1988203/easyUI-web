...
<script src="${ctx}/static/js/views/system/notice/addNotice.js?V=${versionNo}"></script>
...
<div class="ub ub-ver  ub-f1  uw uh ufs-14 uc-black">
	...
	<form id="formNoticeAdd">
		<div class="ub ub-ver upad-4">
			...
			<div class="ub upad-4 umar-t10">
				<div class="ub ub-ac" id="operatorComponent">
			...
			<div class="ub upad-4 umar-t10">
				<div class="ub ub-ac uw-600">
					...
					<textarea id="content" name="content" placeholder="公告内容必填"
						class="uh-300 umar-r30 ubor ub ub-f1" maxlength="200"></textarea>
				</div>
			</div>
