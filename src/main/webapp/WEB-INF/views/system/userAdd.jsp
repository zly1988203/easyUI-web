     ...
     <form id="addUserForm" method="post" >
          ...
          <div class="ub umar-t8">
	            <div class="ub ub-ac umar-l20">
	                ...
	                <input  id="userName" name="userName" class="uinp easyui-validatebox" data-options="required:true,validType:'userName'" type="text">
                <i class="uc-red">*</i>
	            </div>
          </div>
           <div class="ub umar-t8">
           ...
           <div class="ub umar-t8">
	            <div class="ub ub-ac umar-l20">
	               ...
	               <input id="mobile" name="mobile" class="uinp easyui-validatebox" data-options="required:false,validType:'mobile'" type="text">
