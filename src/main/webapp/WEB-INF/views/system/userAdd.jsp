       ...
       <div style="display:inline-block;">
          ...
          <div class="ub umar-t20">
	            <div class="ub ub-ac umar-l20">
	                ...
	                <input  id="userName" name="userName" class="uinp uw-250 easyui-validatebox" data-options="required:true,validType:'userName'" type="text">
                <i class="uc-red">*</i>
	            </div>
          </div>
           <div class="ub umar-t20">
	            <div class="ub ub-ac umar-l20">
	               ...
	               <input  id="password" name="password" class="uinp uw-250 easyui-validatebox" data-options="required:true" type="password" maxlength="20">
                   <i class="uc-red">*</i>
	            </div>
          </div>
           <div class="ub umar-t20">
	            <div class="ub ub-ac umar-l20">
	               ...
	               <input id="mobile" name="mobile" class="uinp uw-250 easyui-validatebox" data-options="required:false,validType:'mobile'" type="text">
