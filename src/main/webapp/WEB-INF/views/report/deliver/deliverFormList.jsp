...
<div class="ub ub-ver ub-f1 umar-4 upad-4">
    <form id="queryForm" action="" method="post">
        <div class="ub ub-ac">
            <div class="ubtns">
                <shiro:hasPermission name="newJxcDeliverList:search">
                    <div class="ubtns-item" onclick="queryForm()">查询</div>
                </shiro:hasPermission>
                <shiro:hasPermission name="newJxcDeliverList:export">
        ...
        <div class="ub umar-t8">
            ...
            <div class="ub ub-ac">
                ...
                <select class="uselect easyui-combobox" style="width: 204px"
                        name="deliverType" id="deliverType">
                    <option value="">全部</option>
                    <option value="DO">配送出库</option>
                    <option value="DI">配送入库</option>
                </select>
            </div>
            <div class="ub ub-ac uw-300 umar-l40" id="categorySelect">
