			...
			<div class="ub ub-ac">
	            ...
	            <div class="ub umar-t8">
	                ...
	                <div class="ub ub-ac uw-300 umar-l40">
	                    ...
	                    <input class="uinp ub ub-f1" type="text" id="sourceBranchName" name="sourceBranchName" onclick="selectSourceBranches()" />
	                    <div class="uinp-more" onclick="selectSourceBranches()" >...</div>
	                </div>
	                <div class="ub ub-ac uw-300 umar-l40">
	                    ...
	                    <input class="uinp ub ub-f1" type="text" id="targetBranchName" name="targetBranchName" value="${branchesGrow.targetBranchName}" onclick="selectTargetBranches()" />
