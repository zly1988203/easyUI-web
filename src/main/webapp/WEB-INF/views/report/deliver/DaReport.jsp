...
<script
	src="${ctx}/static/js/views/report/deliver/DaReport.js?V=${versionNo}"></script>
</head>
		...
		<form id="queryForm" action="" method="post">
			...
			<div class="ub umar-t8">
				<div class="ub ub-ac" id="targetBranch">
					...
					<input type="hidden" id="targetBranchId" name="targetBranchId" /> <input
			...
			<div class="ub umar-t8">
				...
				<div class="ub ub-ac umar-l40">
					...
					<div class="ub ub-ac umar-r10">
						<label> <input type="radio" name="deliverStatus" value="0"
							onclick="queryForm()" /><span>待处理</span>
						</label>

					</div>
					<div class="ub ub-ac umar-r10">
						<label> <input type="radio" name="deliverStatus" value="1"
							onclick="queryForm()" /><span>部分发货</span>
						</label>

					</div>
					<div class="ub ub-ac umar-r10">
						<label> <input type="radio" name="deliverStatus" value="2"
							onclick="queryForm()" /><span>全部发货</span>
						</label>

					</div>
					<div class="ub ub-ac umar-r10">
						<label> <input type="radio" name="deliverStatus" value="3"
							onclick="queryForm()" /><span>终止</span>
						</label>

					</div>
					<div class="ub ub-ac umar-r10">
						<label> <input type="radio" name="deliverStatus" value=""
							checked="checked" onclick="queryForm()" /><span>全部</span>
						</label>
