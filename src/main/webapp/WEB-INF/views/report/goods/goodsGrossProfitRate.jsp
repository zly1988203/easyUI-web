...
<script src="${ctx}/static/js/views/report/goods/goodsGrossProfitRate.js?V=${versionNo}"></script>
<style>
...
<div class="ub ub-ver ub-f1 umar-4 upad-4">
	        ...
	        <div class="ub umar-t8">
			    <div class="ub ub-ac umar-r40" id="branchSelects">
			        ...
			        <input class="uinp" type="hidden" id="branchId" name="branchId">
		         	<input class="uinp" type="hidden" id="allBranch" name="allBranch">
			        <input class="uinp" type="hidden" id="type" name="type">
        ...
        <div class="ub ub-f1 umar-t20">
			 <table id="goodsRateMarginList"></table>
		</div>
    </div>
</body>
</html>