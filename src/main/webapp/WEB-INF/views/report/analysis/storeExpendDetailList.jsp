...
<title>门店费用开支明细分析</title>

<%@ include file="/WEB-INF/views/include/header.jsp"%>
<c:set var="ctx" value="${pageContext.request.contextPath}" />
<script src="${ctx}/static/js/views/report/analysis/storeExpendDetailList.js?V=${versionNo}"></script>
<style>
...
<body class="ub uw uh ufs-14 uc-black">
    ...
    <div class="ub ub-ver ub-f1 umar-4 upad-4">
                ...
                <div class="ub ub-ac umar-l70">
					...
					<div class="ub ub-ac  uh-36">
						<label class="umar-r10"> <input id="OWN_STORE" 
							type="radio" name="branchType" value="3" checked="checked" />直营店
						</label>
					</div>
					...
					<div class="ub ub-ac umar-r10">
						<label> <input class="radioItem" id="allType" 
							type="radio" name="branchType" value="" /> 所有
						</label>
					</div>
				</div>
            </div>
        ...
        <div class="ub ub-f1 umar-t20">
			 <table id="gridStoreExpendDetail"></table>
		</div>
    </div>
