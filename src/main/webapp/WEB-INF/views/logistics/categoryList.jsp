...
<head>
    ...
    <script  src="${ctx}/static/js/views/logistics/categoryList.js?V=${versionNo}"></script>
</head>
...
<div class="ub  ub-f1 umar-4 upad-4">
   ...
   <!--left end-->
    <div class="ub ub-ver ub-f1 upad-4">
        <div class="ub ub-ac">
            <div class="ubtns">
            	<shiro:hasPermission name="JxcCategoryLogistics:search">
					<button class="ubtns-item" onclick="queryList()">查询</button>
			   	</shiro:hasPermission>
			   	<shiro:hasPermission name="JxcCategoryLogistics:export">
