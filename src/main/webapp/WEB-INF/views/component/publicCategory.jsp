            ...
            <form action="" id="formCategory">
                <div class="ub ub-ac upad-10 ">
                    <div class="ub ub-ac uw">
                        ...
                        <input class="usearch uinp ub ub-f1" type="text" name="categoryNameOrCode" id="categoryNameOrCode">
                        <div class="ubtn umar-l20" onclick="categorySearch()">查询</div>
                    </div>
                </div>
            </form>

            <div class="ub uw uh ub-f1">
                <table id="gridCategory" style="width: 100%;height: 100%"></table>
            </div>
        </div>
    </div>
</div>
