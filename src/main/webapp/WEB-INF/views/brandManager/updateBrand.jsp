...
<script src="${ctx}/static/js/views/brandManager/updateBrand.js?V=${versionNo}"></script>
		...
		<div class="ub ub-ver upad-4">
			<div class="ub upad-4">
				<div class="ub ub-ac uw-320">
					...
					<input id="brandCode" name="brandCode" class="uinp uinp-no-more easyui-validatebox uw-200" data-options="required:true,validType:'intNum'" readonly="readonly"  maxlength="10" value="${goodsBrand.brandCode }">
					<i class="uc-red">*</i>
				</div>
			</div>
			<div class="ub upad-4">
				<div class="ub ub-ac uw-320">
					...
					<input id="brandName" name="brandName" class="uinp uw-200" class="uinp" type="text" value="${goodsBrand.brandName}" maxlength="20"
