...
<script src="${ctx}/static/js/views/sale/group/groupDialog.js?V=${versionNo}1"></script>
		...
		<div class="ub ub-ver upad-4">
			<div class="ub upad-4 umar-t10">
				<div class="ub ub-ac">
					...
					<input  type="hidden" id="branchId" name="branchId" value="<c:out value="${branchId}"/>"/>
					<input class="uinp ub ub-f1 uinp-no-more" type="text" id="groupNo"
						name="groupNo" readOnly value="<c:out value="${groupCode}"/>"/>
				</div>
			</div>
			...
			<div class="ub upad-4 umar-t10">
				<div class="ub ub-ac">
					...
					data-options="min:0,max:999,precision:0" type="text" id="sortNo"
						name="sortNo"/>
					<i class="uc-red">*</i>
				</div>
			</div>
