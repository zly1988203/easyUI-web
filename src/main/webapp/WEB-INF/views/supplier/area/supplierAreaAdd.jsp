...
<script  src="${ctx}/static/js/views/supplier/area/supplierAreaAdd.js?V=${versionNo}"></script>
	...
	<form id="formAdd" method="post">
		<div class="ub ub-ver ub-ac upad-4">
			<div class="ub ub-ac umar-t20">
				...
				<input id="areaCode" name="areaCode" class="uinp easyui-validatebox" data-options="required:true,validType:['int','minLength[2]']" maxlength="2" >
			</div>
			<div class="ub ub-ac umar-t20">
