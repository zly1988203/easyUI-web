...
<script  src="${ctx}/static/js/views/supplier/archive/supplierArchiveEdit.js?V=${versionNo}"></script>
		...
		<div class="ub ub-ver upad-4">
			...
			<div class="ub upad-4">
				...
				<div class="ub ub-ac uw-320">
					...
					<select class="uselect easyui-combobox" name="stampsType" style="width: 204px;" id="stampsType" data-options="editable:false">
			...
			<div class="ub upad-4">
				...
				<div class="ub ub-ac uw-320">
					...
					<input class="Wdate uinp uw-200" style="width: 201px;" readonly="readonly" name="contractDate" id="contractDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  value="<fmt:formatDate value="${supplier.contractDate}" pattern="yyyy-MM-dd"/>"  />
				</div>
				<div class="ub ub-ac uw-320">
