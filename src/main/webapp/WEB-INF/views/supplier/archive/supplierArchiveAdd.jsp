		...
		<div class="ub ub-ver upad-4">
			<div class="ub upad-4">
				<div class="ub ub-ac uw-320">
					...
					<input id="supplierIdVal" name="supplierIdVal" type="hidden" value="${supplier.id }">
					<input id="supplierCode" name="supplierCode" class="uinp uw-200"  type="text" readonly="readonly" value="">
				</div>
				<div class="ub ub-ac uw-320">
			...
			<div class="ub upad-4">
				...
				<div class="ub ub-ac uw-320">
					...
					<select class="uselect easyui-combobox easyui-validatebox" style="width: 204px;" name="supplierAreaId" id="supplierAreaId" data-options="editable:false">
			...
			<div class="ub upad-4">
				...
				<div class="ub ub-ac uw-320">
					...
					<select class="uselect easyui-combobox" style="width: 204px;" name="stampsType" id="stampsType" data-options="editable:false">
			...
			<div class="ub upad-4">
				...
				<div class="ub ub-ac uw-320">
					...
					<input class="Wdate uinp uw-200" style="width: 202px;" readonly="readonly" name="contractDate" id="contractDate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  value="<fmt:formatDate value="${supplier.contractDate}" pattern="yyyy-MM-dd"/>"  />
				</div>
				<div class="ub ub-ac uw-320">
					<div class="umar-r10 uw-80 ut-r">采购人员:</div>
					<input id="purchaseStaffName" name="purchaseStaffName" value="${supplier.purchaseStaffName }" class="uinp easyui-validatebox" maxlength="20">
				</div>
			...
			<div class="ub upad-4">
				...
				<div class="ub ub-ac uw-320">
					...
					<select class="uselect easyui-combobox" style="width: 204px;" name="deliverTime" id="deliverTime" data-options="editable:false">
				...
				<div class="ub ub-ac uw-320">
					...
					<select name="orderNumType uselect" style="width: 60px;height: 32px;">
						<option value="0">金额</option>
						<option value="1">数量</option>
					</select>
					<input id="orderNumLimit" style="width: 135px;" name="orderNumLimit" value="${supplier.orderNumLimit }" 
						class="uinp easyui-validatebox" data-options="validType:'intOrFloat'" maxlength="20">
				</div>
			</div>
			<div class="ub upad-4">
				<div class="ub ub-ac uw-320">
					<div class="umar-r10 uw-80 ut-r">结算方式:</div>
					<select class="uselect easyui-combobox" name="balanceWay" style="width: 204px;" id="balanceWay" data-options="editable:false">
			...
			<div class="ub upad-4">
				<div class="ub ub-ac uw-320">
					...
					<select class="uselect easyui-combobox" style="width: 204px;" name="freezeAccount" id="freezeAccount" data-options="editable:false">
				...
				<div class="ub ub-ac uw-320">
					...
					<select class="uselect easyui-combobox" style="width: 204px;" name="freezeBusiness" id="freezeBusiness" data-options="editable:false">
						<option value="0">正常</option>
						<option value="1">冻结</option>
					</select>
