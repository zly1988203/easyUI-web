...
<head>
	...
	<script src="${ctx}/static/js/views/deliver/deliver.js?V=${versionNo}6"></script>
</head>
    ...
    <div class="ub ub-ver ub-f1 umar-4  ubor">
        ...
        <div class="ub ub-ac upad-4">
           ...
           <div class="ub">
               <div class="ub ub-ac uw-300">
                   ...
                   <div class="ub">
                       ...
                       <input type="hidden" id="isMinAmount" name="isMinAmount" value="${branchesGrow.isMinAmount}"  />
           ...
           <div class="ub umar-t8">
               ...
               <div class="ub ub-ac umar-l30 uw-292">
               <shiro:hasPermission name="JxcDeliverDA:suggest">
