...
//top-=(tip._outerHeight()-t._outerHeight())/2;//huangjiang 2016-9-17 17:33:10
break;
case "left":
...
//$(_8ee).html(_8f1.join(""));
$(_8ee)[0].innerHTML = _8f1.join("");  
}else{
//$(_8ee).html(this.renderTable(_8ed,0,_8f0.data.rows,_8ef));
$(_8ee)[0].innerHTML = this.renderTable(_8ed,0,_8f0.data.rows,_8ef);  
}
