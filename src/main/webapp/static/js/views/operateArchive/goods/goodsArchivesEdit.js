...
function getGoodsArchivesDetail(id){
	var args = {}
	var httpUrl = contextPath+"/common/operateGoods/getGoodsSkuById?id="+id;
...
//提交表单
function submitForm(){
	var url = contextPath+'/common/operateGoods/updateGoods';
...
function goodsAddView(){
	closeDialog();
	openDialog(contextPath+"/common/operateGoods/addGoodsView","新增商品档案","add","");
}
...
//	var newUrl = contextPath+"/common/operateGoods/addGoodsView?data="+escape(data);
