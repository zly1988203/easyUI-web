        ...
        columns:[[
            ...
            {field: 'formNo',title:'单据编号',width:'130px',align:'left',formatter:function(value,row,index){
            	...
            	if(row.auditStatus == 1){
            		strHtml = '<a style="text-decoration: underline;" href="#" onclick="toAddTab(\'加盟店费用明细\',\''+ contextPath +'/settle/franchiseCharge/chargeView?id='+ row.id +'\')">' + value + '</a>';
            	}else{
            		strHtml = '<a style="text-decoration: underline;" href="#" onclick="toAddTab(\'加盟店费用明细\',\''+ contextPath +'/settle/franchiseCharge/chargeEdit?id='+ row.id +'\')">' + value + '</a>';
            	}
        		return strHtml;
            }},
...
function queryForm(){
	...
	$("#"+datagirdID).datagrid('options').url = contextPath + '/settle/franchiseCharge/getChargeList';
