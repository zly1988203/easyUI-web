...
function queryForm(){
 ...
 $("#startCount").attr("value",null);
	...
	$("#storeDaySale").datagrid('options').url = contextPath + '/storeDaySale/report/new/getStoreDaySaleList';
...
function exportExcel(){
	...
	$("#queryForm").attr("action",contextPath+"/storeDaySale/report/new/exportList");
	$("#queryForm").submit();
}
