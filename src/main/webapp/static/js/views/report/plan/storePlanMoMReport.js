...
function getColumns(){
	...
	if(hasCostPrice){
		...
		{field:'lastSaleNum',title:'上月实际销售',width: 100,align:'center',colspan:1},
		{field:'lastMonthComplePercentStr',title:'上月销售完成率',width: 100,align:'right',rowspan:2,
			formatter:function(value,row,index){
      		return '<b>'+value+'</b>';
      	}
		...
		{field:'curTarget',title:'当月目标',width: 100,align:'center',colspan:3},
		{field:'curSaleNum',title:'当月实际销售',width: 100,align:'center',colspan:1},
		{field:'currMonthSaleHbPercentStr',title:'当月销售金额环比',width: 110,align:'right',rowspan:2,
			formatter:function(value,row,index){
      		return '<b>'+value+'</b>';
      	}
		...
		{field:'nextMonthPlanGrowthRateStr',title:'下月计划增长率',width: 100,align:'right',rowspan:2,
         ...
         {field:'lastMonthSaleAmount',title:'销售金额',width: 100,align:'right',
            	formatter:function(value,row,index){
            		return '<b>'+parseFloat(value||0).toFixed(2)+'</b>';
            	}
            },
            ...
            {field:'currMonthSaleAmount',title:'销售金额',width: 100,align:'right',
            	formatter:function(value,row,index){
            		return '<b>'+parseFloat(value||0).toFixed(2)+'</b>';
            	}
            },
