...
var gridName = "gridNonExpendList";
...
function queryStoreCharge() {
    ...
    $("#"+gridName).datagrid("options").url = contextPath+'/finance/nonExpend/getExpendList';
...
function editHandel(formId) {
    toAddTab("营业外支出详情",contextPath + "/finance/nonExpend/toEdit?formId="+formId);
}
