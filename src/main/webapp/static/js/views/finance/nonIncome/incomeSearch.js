        ...
        return [[
            {field:'formNo',title:'单号',width:180,align:'left',
                formatter:function(value,row,index){
                	...
                	var strHtml = '<a style="text-decoration: underline;" href="#" onclick="toAddTab(\'营业外收入详情\',\'' + contextPath + '/finance/nonIncome/toEdit?formId=' + row.id + '\');">' + value + '</a>';
                	return strHtml;
                },
            },
            {field:'branchCode',title:'机构编码',width:80,align:'left'},
            ...
            {field:'costTypeName',title:'收入项目',width:180,align:'left'},
            {field:'amount',title:'金额',width:110,align:'right',
                formatter:function(value,row,index){
                    if(row.isFooter){
                        return
