...
var gridName = "gridNonIncomeList";
...
function initGridBranchCostList() {
    ...
    $("#"+gridName).datagrid({
        ...
        columns:[[
            ...
            {field:'month',title:'收入月份',width:80,align:'right',
                formatter : function(value, row, index) {
                    var month = value+"";
...
function queryStoreCharge() {
    ...
    $("#"+gridName).datagrid("options").url = contextPath+'/finance/nonIncome/getIncomeList';
...
function editHandel(formId) {
    toAddTab("营业外收入详情",contextPath + "/finance/nonIncome/toEdit?formId="+formId);
}
