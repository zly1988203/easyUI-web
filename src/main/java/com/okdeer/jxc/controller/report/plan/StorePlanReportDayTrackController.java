...
/**
 * ClassName: StorePlanReportDayTrackController 
...
public class StorePlanReportDayTrackController extends ReportController {
	
	@RequestMapping(value = "toManager")
	public String toManager() {
		return "report/plan/storePlanDayTrackReport";
	}
