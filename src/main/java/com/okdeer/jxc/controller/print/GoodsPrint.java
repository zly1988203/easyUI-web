...
import com.okdeer.retail.common.price.DataAccess;
...
public class GoodsPrint implements Serializable {
	 ...
	 */
	@DataAccess(key = PriceConstant.PURCHASE_PRICE)
	private BigDecimal purchasePrice;

	/**
	 * @Fields salePrice : 销售价
	 */
	@DataAccess(key = PriceConstant.SALE_PRICE)
	private BigDecimal salePrice;

	/**
	 * @Fields wholesalePrice : 批发价
	 */
	@DataAccess(key = PriceConstant.WHOLESALE_PRICE)
	private BigDecimal wholesalePrice;

	/**
	 * @Fields vipPrice : 会员价
	 */
	@DataAccess(key = PriceConstant.VIP_PRICE)
	private BigDecimal vipPrice;

	/**
	 * @Fields distributionPrice : 配送价
	 */
	@DataAccess(key = PriceConstant.DISTRIBUTION_PRICE)
